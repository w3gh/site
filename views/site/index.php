...
<div class="masthead clearfix">
    <div class="container">
        <p class="lead">
            Мощная система для создания игр в Battle.net и Локальной сети.
            Позволяет сделать игровой процесс более удобным и приятным.
            Кросплатформенна. Дистрибутив игры не нужен, достаточно пары файлов.
        </p>

        <p class="lead center">
            <a class="btn btn-outline-inverse btn-lg" href="<?=url(['/site/download'])?>">Скачать</a>
            <a class="btn btn-outline-inverse btn-lg" href="<?=url(['/site/guide'])?>">Руководство</a>
        </p>
    </div>
</div>
